...
function TVSeason(props) {
  ...
  return (
    <div>
      ...
      <div className="season-episode-wrapper">
          ...
          {Detail ? (
            <div>
              {Detail.episodes.map((episode, index) => {
                return (
                  <a
                    href={`/TV/${props.match.params.id}/${props.match.params.title}/season/${episode.season_number}/episode/${episode.episode_number}`}
                    key={index}
                  >
                    <div className="season-episode-card">
                      ...
                      <div>
                        ...
                        <h5>
                          User Score: <span className="user-score">{episode.vote_average.toFixed(1)}</span> (
                          {episode.vote_count} voted)
                        </h5>
                      </div>
                    </div>
                  </a>
